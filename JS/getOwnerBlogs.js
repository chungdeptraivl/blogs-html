...
async function getHomeBlogs(token) {
  try {
    ...
    const authorId = urlParams.get("ownerId");
...
<a class="profile" href="/blogOfUser.html?userId=${postData.author.id}">
    ...
    <div class="btn-post-action">
        <a href="/edit-post-page.html?postId=${postData.id}" class="btn btn-edit">Sua</a>
        <a href="/delete-post-page.html?postId=${postData.id}" class="btn btn-delete">Xoa</a>
    </div>
</div>
`;
